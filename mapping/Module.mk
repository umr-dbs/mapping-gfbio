...
TARGET_MANAGER_OBJS = o/core/mapping_manager.o ${OBJS_CORE}
...
TARGET_CGI_OBJS = o/core/cgi.o ${OBJS_CORE} ${OBJS_SERVICES}
...
TARGET_CACHENODE_OBJS = ${OBJS_CORE} ${OBJ_NODE_SERVER} o/core/cache/node/nodeserver_main.o

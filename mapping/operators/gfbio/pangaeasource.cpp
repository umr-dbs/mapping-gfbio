 ...
 */
class PangaeaSource : public GenericOperator {
	public:
		PangaeaSource(int sourcecounts[], GenericOperator *sources[], Json::Value &params) : GenericOperator(sourcecounts, sources) {
			assumeSources(0);
...
void PangaeaSource::getStringFromServer(std::stringstream& data) {

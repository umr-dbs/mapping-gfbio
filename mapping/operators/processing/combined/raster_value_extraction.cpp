...
RasterValueExtractionOperator::RasterValueExtractionOperator(int sourcecounts[], GenericOperator *sources[], Json::Value &params) : GenericOperator(sourcecounts, sources) {
//	assumeSources(2);
...
RasterValueExtractionOperator::~RasterValueExtractionOperator() {
}
